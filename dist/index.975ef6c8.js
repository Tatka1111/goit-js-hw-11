...
async function eventHandler(e) {
    ...
    (0, _fetchImages.fetchImages)(name, page, perPage).then((name1)=>{
        let totalPages = name1.totalHits / perPage;
        if (name1.hits.length > 0) {
            (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${name1.totalHits} images.`);
            renderGallery(name1);
...
function renderGallery(name2) {
    const markup = name2.hits.map((hit)=>{
...
loadBtn.addEventListener("click", ()=>{
    name = searchQuery.value;
    page += 1;
    (0, _fetchImages.fetchImages)(name, page, perPage).then((name3)=>{
        let totalPages = name3.totalHits / perPage;
        renderGallery(name3);
        new (0, _simplelightboxDefault.default)(".gallery a");
        if (page >= totalPages) {
            loadBtn.style.display = "none";
...
// Preloader
window.addEventListener("load", (0, _preloader.fadeEffect));

},{"simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","notiflix":"5z0Oc","./js/preloader":"gkVpk","./js/fetchImages":"dOg5x","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ydBq":[function(require,module,exports) {
/*!
...
},{}],"gkVpk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fadeEffect", ()=>fadeEffect);
...
async function fetchImages(name, page, perPage) {
    ...
    try {
        const response = await (0, _axiosDefault.default).get(`${baseURL}?key=${key}&q=${name}&image_type=photo&orientation=horizontal&safesearch=true&page=${page}&per_page=${perPage}`);
...
},{"../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","buffer":"etYot","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3u8Tl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utilsJs = require("../utils.js");
var _utilsJsDefault = parcelHelpers.interopDefault(_utilsJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"etYot":[function(require,module,exports) {
/*!
...
},{"base64-js":"klply","ieee754":"kgcem","isarray":"lzco6"}],"klply":[function(require,module,exports) {
"use strict";
...
},{}],"kgcem":[function(require,module,exports) {
...
},{}],"lzco6":[function(require,module,exports) {
